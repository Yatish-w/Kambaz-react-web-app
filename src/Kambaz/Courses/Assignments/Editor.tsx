    ...
    <div id="wd-assignments-editor" className="me-4">
      ...
      <div className="row">
        ...
        <div className="border border-secondary rounded p-3 mb-3 col">
          ...
          <input type="date" id="wd-due-date" defaultValue="2024-09-20" className="form-control mb-2" />

          <div className="row">
            <div className="col">
              <label htmlFor="wd-available-from"><b>Available From</b></label>
              <input type="date" id="wd-available-from" defaultValue="2024-09-20" className="form-control mb-2" />
            </div>
            <div className="col">
              <label htmlFor="wd-available-until"><b>Until</b></label>
              <input type="date" id="wd-available-until" defaultValue="2024-09-20" className="form-control mb-2" />
            </div>
          </div>
        </div>
      </div>
